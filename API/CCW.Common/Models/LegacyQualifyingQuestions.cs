...
{
    public class LegacyQualifyingQuestions
    {
        public QualifyingQuestionOne QuestionOne { get; set; }
        public QualifyingQuestionTwo QuestionTwo { get; set; }
        public QualifyingQuestionStandard QuestionThree { get; set; }
        public QualifyingQuestionStandard QuestionFour { get; set; }
