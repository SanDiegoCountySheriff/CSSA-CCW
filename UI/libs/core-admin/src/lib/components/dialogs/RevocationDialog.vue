          ...
          <v-card-text class="mt-2">
            <v-row>
              <v-col cols="12">
                <v-select
                  v-model="
                    permitStore.permitDetail.application.revocationInfo.reason
                  "
                  label="Reason"
                  outlined
                  required
                  :items="[
                    'Disqualified Person (PC § 26202)',
                    'Moved Out of County/City',
              ...
              <v-col cols="12">
                ...
                >
                  <template #activator="{ on }">
                    <v-text-field
                      v-model="
                        permitStore.permitDetail.application.revocationInfo.date
                      "
            ...
            >
              <v-col cols="12">
                <v-text-field
                  v-model="
                    permitStore.permitDetail.application.revocationInfo
                      .otherReason
                  "
                  label="Other Reason"
                  outlined
