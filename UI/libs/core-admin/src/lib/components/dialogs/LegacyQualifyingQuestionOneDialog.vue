...
function handleSaveQuestionOneFlag() {
  if (permitStore.getPermitDetail.application.legacyQualifyingQuestions) {
    permitStore.getPermitDetail.application.legacyQualifyingQuestions.questionOne.temporaryAgency =
      temporaryAgency.value
    permitStore.getPermitDetail.application.legacyQualifyingQuestions.questionOne.temporaryIssueDate =
      temporaryIssueDate.value
    permitStore.getPermitDetail.application.legacyQualifyingQuestions.questionOne.temporaryNumber =
      temporaryNumber.value
    permitStore.getPermitDetail.application.legacyQualifyingQuestions.questionOne.temporaryIssuingState =
