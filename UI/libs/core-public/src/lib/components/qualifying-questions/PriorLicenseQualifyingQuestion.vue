    ...
    >
      ...
      >
        <v-text-field
          ...
          v-model="viewModel.issuingState"
          :rules="[v => !!v || $t('Field cannot be blank')]"
        >
        </v-text-field>
      </v-col>
...
import { QualifyingQuestionOne } from '@shared-utils/types/defaultTypes'
