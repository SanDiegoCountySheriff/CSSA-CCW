  ...
  <div>
    ...
    >
      ...
      <v-card-text>
        ...
        <v-autocomplete
          v-if="model.application.currentAddress.country === 'United States'"
      ...
      <div v-if="model.application.differentMailing">
        ...
        <v-card-text>
          ...
          <v-autocomplete
            v-if="model.application.mailingAddress.country === 'United States'"
      ...
      <div v-if="model.application.differentSpouseAddress">
        ...
        <v-card-text>
          <v-text-field
            v-model="model.application.spouseAddressInformation.addressLine1"
          ...
          <v-text-field
            v-model="model.application.spouseAddressInformation.addressLine2"
